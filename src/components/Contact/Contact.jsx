...
const Contact = () => {
    const numeroTelefono = '+5493437401892'
  return (
    <div className="w-full h-20  flex items-center justify-between pb-10">
      ...
      <div className="flex justify-center items-center mr-20 space-x-8 ">
        ...
        <a
          href="https://api.whatsapp.com/send?phone=5493437401892"
          target="_blank"
          className="shadow-lg rounded-full"
        >
